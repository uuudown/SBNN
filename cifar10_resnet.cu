 ...
 *  @brief A ResNet-14 network for CIFAR10.
 *  @author Ang Li (PNNL)
 *
*/
...
int main32()
{
    ...
    In32Conv32LayerParam* bconv1 = new In32Conv32LayerParam("Conv1", image_height, image_width, 
            3, 3, 3, 128, batch,1,1,true,0,0,false,true);//save residual 
    ...
    Conv32LayerParam* l1b1c2 = new Conv32LayerParam("L1B1C2", l1b1c1->output_height, 
            l1b1c1->output_width, 3, 3, 128, 128, batch,1,1,true,0,0,false,true,true,128);
    ...
    Conv32LayerParam* l1b2c2 = new Conv32LayerParam("L1B2C2", l1b2c1->output_height, 
            l1b2c1->output_width, 3, 3, 128, 128, batch,1,1,true,0,0,false,true,true,128);
    ...
    Conv32LayerParam* l2b1c2 = new Conv32LayerParam("L2B1C2", l2b1c1->output_height, 
            l2b1c1->output_width, 3, 3, 256, 256, batch,1,1,true,0,0,false,true,true,128,true);
    ...
    Conv32LayerParam* l2b2c1 = new Conv32LayerParam("L2B2C1", l2b1c2->output_height, 
            l2b1c2->output_width, 3, 3, 256, 256, batch, 1, 1);
    ...
    Conv32LayerParam* l2b2c2 = new Conv32LayerParam("L2B2C2", l2b2c1->output_height, 
            l2b2c1->output_width, 3, 3, 256, 256, batch,1,1,true,0,0,false,true,true,256);
    ...
    Conv32LayerParam* l3b1c2 = new Conv32LayerParam("L3B1C2", l3b1c1->output_height, 
            l3b1c1->output_width, 3, 3, 512, 512, batch,1,1,true,0,0,false,true,true,256,true);
    ...
    Conv32LayerParam* l3b2c2 = new Conv32LayerParam("L3B2C2", l3b2c1->output_height, 
            l3b2c1->output_width, 3, 3, 512, 512, batch,1,1,true,0,0,true,false,true,512);
    Conv32LayerParam* l3b2c2_gpu = l3b2c2->initialize(config_file, l3b2c1->get_output_gpu(),
            l3b1c2->get_residual_gpu());
    //Layer-4
    Fc32LayerParam* bfc1 = new Fc32LayerParam("Fc1", batch, (l3b2c2->output_height)
            *(l3b2c2->output_width)*512, 512); 
    Fc32LayerParam* bfc1_gpu = bfc1->initialize(config_file, l3b2c2->get_output_gpu());
    //Out Layer
...
int main64()
{
    ...
    //================ Get Weight =================
    //FILE* config_file = fopen("../pytorch/BinaryNet/vgg_cifar10.csv","r");
    FILE* config_file = fopen("./pytorch_training/resnet_cifar10.csv","r");
    //================ Set Network =================
    //Bconv1 Layer
    In32Conv64LayerParam* bconv1 = new In32Conv64LayerParam("Conv1", image_height, image_width, 
            3, 3, 3, 128, batch,1,1,true,0,0,false,true); 
    ...
    //Layer-4
    Fc64LayerParam* bfc1 = new Fc64LayerParam("Fc1", batch, (l3b2c2->output_height)
            *(l3b2c2->output_width)*512, 512); 
    Fc64LayerParam* bfc1_gpu = bfc1->initialize(config_file, l3b2c2->get_output_gpu());
    //Out Layer
    ...
    //resnet64<<<numBlocksPerSm*deviceProp.multiProcessorCount, numThreads, shared_memory>>> (
